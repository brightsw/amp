var require = {
    waitSeconds: 0,
    paths: {
        jquery: ["../plugin/jquery/dist/jquery.min", "../plugin/jquery/dist/jquery.min"],
        ...
        "angular-translate": "../plugin/angular-translate/angular-translate.min",
        "angular-translate-loader-static-files": "../plugin/angular-translate-loader-static-files/angular-translate-loader-static-files.min",
...
//        "angular-bootstrap": "../plugin/angular-bootstrap/ui-bootstrap-tpls.min",
        ...
        "angular-file-upload": "../plugin/angular-file-upload/dist/ng-file-upload",
        'angular-file-upload-shim': '../plugin/angular-file-upload/dist/ng-file-upload-shim',
        ...
        //echarts: "../plugin/echarts-3.1.3/dist/echarts-all-3.0.0",
        echarts: "../plugin/echarts-3.1.3/dist/echarts",
        "highcharts-exporting": "../plugin/highcharts/exporting",
        highcharts: "../plugin/highcharts/highcharts",
        chartjs: "../plugin/chartjs/chart.min",
        d3: "../plugin/d3/d3",
        "d3-sankey": "../plugin/d3/sankey",
       ...
       /* jqgrid: "../plugin/jqgrid/js/minified/jquery.jqGrid.min",*/
        ...
        "bootstrap-jeditable": "../plugin/bootstrap-jeditable/dist/jquery.jeditable",
        "agile_carousel": "../plugin/agile-carousel/agile_carousel.alpha",
        ...
        "jquery-mCustomScrollbar": "../plugin/jquery-mCustomScrollbar/jquery.mCustomScrollbar.concat.min",
        "jquery-multiselect": "../plugin/jquery-multiselect/jquery.multiselect",
        "jquery-qtip": "../plugin/jquery-qtip/jquery.qtip",
        lodash: "../plugin/lodash/dist/lodash.min",
        "magnific-popup": "../plugin/magnific-popup/dist/jquery.magnific-popup",
        fullcalendar: "../plugin/smartadmin/fullcalendar/jquery.fullcalendar.min",
        smartwidgets: "../plugin/smartadmin/smartwidgets/jarvis.widget.min",
        notification: "../plugin/smartadmin/notification/SmartNotification.min",
        "angular-dialog-service": '../plugin/dialog/js/dialogs.min',
        "dialogs-default-translations": '../plugin/dialog/js/dialogs-default-translations.min',
        language:'./components/language/Language',
        ztree: '../plugin/ztree/js/jquery.ztree.all-3.5',
        appConfig: "../app.config",
        base64:"../plugin/base64/jquery.base64",
    ...
    shim: {
        ...
        "bootstrap-jeditable": {deps: ["jquery"]},
        "agile_carousel": {deps: ["jquery"]},
        ...
        "angular-dialog-service": {deps: ["angular"]},
        "dialogs-default-translations": {deps: ["angular"]},
        smartwidgets: {deps: ["jquery-ui"]},
        base64: {deps: ["jquery"]},
        language:{deps:["angular"]},
        "d3-sankey":{deps:["d3"]},
		ztree: {exports: 'ztree', deps: ['jquery']}
	    },
