...
!function (a) {
    ...
    function fb() {
        ...
        function j(a, c, d) {
            ...
            c.draggable({
                "opacity": n("dragOpacity", "month"), "revertDuration": n("dragRevertDuration"), "start": function (b, d) {
    ...
    function rb() {
        ...
        function u(a, b) {
            var c, d, e = W();
            b.draggable({
                "delay": 50, "opacity": x("dragOpacity"), "revertDuration": x("dragRevertDuration"), "start": function (f, g) {
