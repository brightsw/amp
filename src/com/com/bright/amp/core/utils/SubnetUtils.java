...
public class SubnetUtils {
    ...
    public SubnetUtils(String startAddress,String endAddressOrMask,boolean flag){
        if(flag){
            calculate(toCidrNotation(startAddress, endAddressOrMask));
        }else{
            network = toInteger(startAddress);
            broadcast = toInteger(endAddressOrMask);
        }
    }
    /**
