...
public class IPv6SubnetInfo extends SubnetInfo {
    ...
    public static void main(String[] args) throws UnknownHostException {
        //InetAddress address = InetAddress.getByName("3ffe:3201:1401::c8ff:fe4d:db39:5");
        InetAddress address = InetAddress.getByName("202.24.24.34");
        if(address instanceof Inet6Address){
            System.out.println(address.getHostAddress());
        }else{
            System.out.println(address.getHostAddress());
        }
        //IPv6SubnetInfo info = new IPv6SubnetInfo((Inet6Address)address,24);
    }
}
