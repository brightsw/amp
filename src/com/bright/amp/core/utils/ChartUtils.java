...
public class ChartUtils {
    private static String NO_DATA_MSG = "没数据";
    ...
    public static void setXAixs(CategoryPlot plot) {
        ...
        plot.getDomainAxis().setLabelAngle(90);
        plot.getDomainAxis().setMaximumCategoryLabelLines(4);
        plot.getDomainAxis().setCategoryLabelPositions(CategoryLabelPositions.DOWN_45);// 横轴 lable 的位置 横轴上的 Lable 45度倾斜 DOWN_45
    }
